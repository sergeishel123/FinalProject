...
SECRET_KEY = 'django-insecure-+4zss6ugnp$cm9a6j1ub6cdo^^4omzshn%(oy2io2nh@%3wi1m'
...
STATIC_ROOT = os.path.join(BASE_DIR,'Project_static_root')
...
LOGIN_REDIRECT_URL = '/posts/personal'
LOGIN_URL = '/'
